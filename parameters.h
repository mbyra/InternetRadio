...
extern std::string MCAST_ADDR;
extern in_port_t DATA_PORT;
extern in_port_t CTRL_PORT_SENDER;
extern unsigned PSIZE;
extern unsigned FSIZE;
extern unsigned RTIME_SENDER;
extern std::string STATION_NAME;

// Messages from communication protocol:
...
// My settings for various system functions:
